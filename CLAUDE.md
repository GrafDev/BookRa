...
## КРИТИЧЕСКОЕ ПРАВИЛО РАЗРАБОТКИ

**ЗАПРЕЩЕНО писать код на основе предположений!**

**ОБЯЗАТЕЛЬНО ПЕРЕД ЛЮБЫМ ИЗМЕНЕНИЕМ КОДА:**

1. **АНАЛИЗИРУЙ** - использовать инструменты Read, Grep, Glob для изучения существующего кода
2. **ПРОВЕРЯЙ** - найти точные места в коде где происходит проблема
3. **ПОНИМАЙ** - разобраться как работает существующая логика
4. **ТОЛЬКО ПОТОМ ИЗМЕНЯЙ** - вносить изменения на основе фактов, а не догадок

**ПРИМЕРЫ НАРУШЕНИЙ:**
- "Возможно тут нужно добавить..." - ЗАПРЕЩЕНО
- "Наверное проблема в том что..." - ЗАПРЕЩЕНО  
- "Попробую сделать так..." без анализа - ЗАПРЕЩЕНО

**ПРАВИЛЬНЫЙ ПОДХОД:**
- Читаю код → Нахожу проблему → Понимаю причину → Исправляю точно

**НЕ ПОДКЛЮЧАТЬ ПОЛЬЗОВАТЕЛЯ К ПРОВЕРКЕ КОДА - ДЕЛАТЬ АНАЛИЗ САМОСТОЯТЕЛЬНО**